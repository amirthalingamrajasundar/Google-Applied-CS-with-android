...
public class GhostActivity extends AppCompatActivity {
    ...
    private void computerTurn() {
        ...
        if(dictionary.isWord(s)) {
            label.setText("OOPS you loose. Please restart to try again!!!");
        }
        else {
            ...
            if(comp_string != null){
                ...
                label.setText("OOPS you bluff. Please restart to try again!!!");
                return;
            }
            userTurn = true;
            label.setText(USER_TURN);
    ...
    public void challangefun(View v){
        ...
        if(dictionary.isWord(s)){
            ...
            textView.setText(dictionary.getAnyWordStartingWith(s));
            t.setText("OOPS above word can be formed. Please restart to try again!!!");
        }
